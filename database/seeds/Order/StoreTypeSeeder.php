...
class StoreTypeSeeder extends Seeder
{
    ...
    public function run($company = null)
    {
        ...
        $admin_service = DB::table('admin_services')->where('admin_service_name', 'ORDER')->first();
        ...
        $menu_list = DB::table('menus')->where('company_id', $company)->where('admin_service_id', $admin_service->id)->get();
