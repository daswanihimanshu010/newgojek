...
class User extends BaseModel implements JWTSubject, AuthenticatableContract, AuthorizableContract
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'gender', 'email', 'mobile', 'picture', 'password', 'device_type','device_token','login_by', 'payment_mode','social_unique_id','device_id','wallet_balance','referral_unique_id', 'user_type','qrcode_url','country_code','company_id','country_id','company_id','city_id','state_id'
    ];
     ...
     */
    protected $hidden = [
     'password', 'remember_token', 'company_id', 'device_token', 'device_id', 'device_type', 'social_unique_id', 'stripe_cust_id', 'otp', 'qrcode_url', 'referral_unique_id', 'referal_count', 'created_type', 'created_by', 'modified_type', 'modified_by', 'deleted_type', 'deleted_by','updated_at',
    ];
