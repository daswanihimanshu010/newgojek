...
class Provider extends BaseModel implements JWTSubject, AuthenticatableContract, AuthorizableContract
{
    ...
    protected $hidden = [
        'company_id', 'password', 'remember_token',  'email_verified_at', 'created_type', 'created_by', 'modified_type', 'modified_by', 'deleted_type', 'deleted_by', 'created_at', 'updated_at', 'deleted_at'
    ];
