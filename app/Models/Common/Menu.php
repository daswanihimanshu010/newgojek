...
class Menu extends BaseModel
{
  ...
  // protected $connection = 'transport';
    ...
    protected $fillable = [
        'bg_color','icon','title', 'admin_service_id', 'menu_type_id', 'company_id', 'sort_order'
    ];
    ...
    {
       return $this->belongsTo('App\Models\Common\AdminService', 'admin_service_id','id');
    }
    ...
    public function scopeSearch($query, $searchText='') {
        return $query
                        ->whereHas('adminservice', function ($q) use ($searchText){
                            $q->where('admin_service_name', 'like', "%" . $searchText . "%");
                        })
