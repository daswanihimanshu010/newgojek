...
class Service extends BaseModel
{
    ...
    return $this->hasMany('App\Models\Common\ProviderService','service_id','id')->where('admin_service_id',3)->where('provider_id',Auth::guard('provider')->user()->id);
    }

    public function provideradminservice() {
        return $this->hasOne('App\Models\Common\ProviderService','service_id','id')->where('admin_service_id',3);
    }
