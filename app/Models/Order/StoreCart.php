...
class StoreCart extends Model
{
    ...
    public function product()
    {
     ...
     public function store() {
        return $this->hasOne('App\Models\Order\Store','id','store_id')->select('store_name','picture','rating','store_packing_charges','store_gst','commission','offer_min_amount','offer_percent','free_delivery','id','store_type_id');
      }
