          ...
          case 'CARD':
            ...
            if($response->status == "SUCCESS") { 
                if($user_type == 'user'){
                    ...
                    (new SendPushNotification)->WalletMoney(Auth::guard('user')->user()->id, $wallet_balance, 'common', 'Wallet amount added', ['amount' => $wallet_balance]);
                }else{
                    ...
                    (new SendPushNotification)->ProviderWalletMoney(Auth::guard('provider')->user()->id, $wallet_balance, 'common', 'Wallet amount added', ['amount' => $wallet_balance]);
                }
