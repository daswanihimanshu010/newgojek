...
class MenuController extends Controller
{
    ...
    public function store(Request $request) 
    {
        ...
        $this->validate($request, [          
            'menu_type_id' =>[ Rule::unique('menus')->where(function ($query) use($request,$company_id) {
                            return $query->where('menu_type_id', $request->menu_type_id)->where('company_id', $company_id)->where('admin_service_id',$request->admin_service_id);
                         }),
                       ],
        ...
        try{
            ...
            $menu->admin_service_id = $request->admin_service_id;                                      
        ...
        $company_id=Auth::user()->company_id;
         ...
         $this->validate($request, [          
            'menu_type_id' =>[ Rule::unique('menus')->where(function ($query) use($request,$company_id, $id) {
                            return $query->where('menu_type_id', $request->menu_type_id)->where('company_id', $company_id)->where('admin_service_id',$request->admin_service_id)->whereNotIn('id', [$id]);
                         }),
                       ],
         ],['menu_type_id.unique'=>"Already Service is Avaliable In Menu"]);
    ...
    {
        $service_list = StoreType::where('company_id', Auth::user()->company_id)->get();
        return Helper::getResponse(['data' => $service_list]);
    }
