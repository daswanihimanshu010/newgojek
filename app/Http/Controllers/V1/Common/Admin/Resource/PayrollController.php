...
class PayrollController extends Controller
{
    ...
    public function PayrollDownload(Request $request,$id){
            $data = Payroll::where('transaction_id',$id)->select('id','transaction_id','payroll_type','status','created_at','updated_at')->get();
            return Excel::download(new PayrollsExport($data),'payroll-'.$id.'.xlsx');
    }
}
