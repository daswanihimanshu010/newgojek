...
class CompanyCitiesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            /*foreach($request->admin_service_id as $service){
                $company_admin_service = new CompanyCityAdminService;
                $company_admin_service->admin_service_id =$service;
    ...
    public function show($id)
    {
        try {
            ...
            $company_city_service['admin_service_id']=CompanyCityAdminService::where('company_city_service_id',$id)->pluck('admin_service_id')->all();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // $company_city_service->admin_service_id = $request->admin_service_id;                         
            $company_city_service->status = $request->status;                    
