    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        try {
            ...
            $datum->save();
             ...
             $admin=AdminService::where('admin_service_name','ORDER')->where('company_id',Auth::user()->company_id)->first();
            $menu=Menu::where('menu_type_id',$id)->where('admin_service_id',$admin->id)->where('company_id',Auth::user()->company_id)->first();
            if(!empty($menu)){
