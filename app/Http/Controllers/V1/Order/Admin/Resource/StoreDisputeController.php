    ...
    public function update(Request $request, $id)
    {
        ...
        //try{
            ...
            if($request->admin_status=='reject'){
                ...
                UserRequest::where('request_id',$Dispute->store_order_id)->delete();
            ...
            {
              $userrequest= UserRequest::where('request_id',$Dispute->store_order_id)->where('admin_service_id',$storeorder->admin_service_id)->where('company_id',Auth::user()->company_id)->first();
              $userrequest->status='ACCEPTED';
              $userrequest->provider_id=$request->provider_id;
              $userrequest->save();
                 
                $Filter = new RequestFilter;
                $Filter->admin_service_id = $storeorder->admin_service_id;
