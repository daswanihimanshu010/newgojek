...
$router->group(['middleware' => 'auth:provider'], function($app) {
	...
	$app->get('/shoptype', 'V1\Order\Provider\HomeController@shoptype'); 
	...
	$app->post('/cancel/order/request', 'V1\Order\Provider\OrderController@cancelOrdered');
	...
	$app->get('/history/order/{id}', 'V1\Order\Provider\OrderController@getServiceHistorydetails');
	$app->get('/history-dispute/order/{id}', 'V1\Order\Provider\OrderController@getServiceRequestDispute');
	$app->post('/history-dispute/order', 'V1\Order\Provider\OrderController@saveServiceRequestDispute');
	$app->get('/getdisputedetails', 'V1\Order\Provider\OrderController@getdisputedetails');
	$app->get('/dispute/order', 'V1\Order\Provider\OrderController@getdisputedetails');
});