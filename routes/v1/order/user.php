...
$router->group(['middleware' => 'auth:user'], function($app) {
	...
	$app->get('/dispute/order', 'V1\Order\Provider\OrderController@getUserdisputedetails');
	...
	$app->post('/order_request_dispute', 'V1\Order\User\HomeController@order_request_dispute');
	$app->get('/get_order_request_dispute/{id}', 'V1\Order\User\HomeController@get_order_request_dispute');
});