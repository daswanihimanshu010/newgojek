...
$router->group(['middleware' => 'auth:provider'], function($app) {
	...
	$app->get('/history-dispute/service/{id}', 'V1\Service\Provider\ServeController@getServiceRequestDispute');
	$app->post('/history-dispute/service/{id}', 'V1\Service\Provider\ServeController@saveServiceRequestDispute');
	...
	$app->get('/getdisputedetails', 'V1\Service\Provider\ServeController@getdisputedetails');
